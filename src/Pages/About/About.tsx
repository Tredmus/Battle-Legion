              ...
              <ul className={classes.organization}>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Легата може да взима еднолични решения и има пълна
                      еднолична власт да добававя, променя и премахва постове и
                      структури в Боен Легион по свое усмотрение.
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Той ръководи Боен Легион в отсъствието на Легата. Ролята
                      му покрива всички функции на Легата.
                      <ol>
                        <li>
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Претора може да взима еднолични решения за легиона си
                      стига да не са в разрез с политиката на Боен Легион и
                      заповедите на Легата.{" "}
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Той ръководи легиона си в отсъствието на Претора. Ролята
                      му покрива всички функции на Претора.
                    </li>
                  </ol>
                </li>
                <li>
                ...
                <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Всеки Легионер представлява Боен Легион и трябва да се
                      държи на съответното ниво за ранга си.
                    </li>
                  </ol>
                </li>
                <li>
